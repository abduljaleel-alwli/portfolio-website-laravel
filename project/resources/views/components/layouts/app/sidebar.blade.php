    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Pages')" class="grid">
                <flux:navlist.item icon="home" :href="route('admin.about')" :current="request()->routeIs('admin.about')"
                    wire:navigate>{{ __('About') }}</flux:navlist.item>
                <flux:navlist.item icon="home" :href="route('admin.contact')" :current="request()->routeIs('admin.contact')"
                    wire:navigate>{{ __('Contact') }}</flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Public')" class="grid">
                ...
                <flux:navlist.item icon="home" :href="route('about.index')" :current="request()->routeIs('about.index')"
                    wire:navigate>{{ __('About') }}</flux:navlist.item>
                <flux:navlist.item icon="home" :href="route('contact.index')"
                    :current="request()->routeIs('contact.index')" wire:navigate>{{ __('Contact') }}</flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.item icon="home" :href="route('admin.settings')"
                :current="request()->routeIs('admin.settings')" wire:navigate>{{ __('Settings') }}</flux:navlist.item>
        </flux:navlist>
