(function ($) {
	...
	var $contactform = $("{{ route('contact') }}Form");
	...
	var $products_item_list = $('.products-item-list');
	if ($products_item_list.length) {
		var $service_item = $products_item_list.find('.service-item');
	...
	var $products_item_list_gold = $('.products-item-list-gold');
	if ($products_item_list_gold.length) {
		var $service_item_gold = $products_item_list_gold.find('.service-item-gold');
